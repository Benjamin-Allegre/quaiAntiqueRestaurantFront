...
let titre ='<img src=x onerror="cindow.location.replace(\'https://google.com\')" />';
let imgSource = "../images/food.jpg";
// Récuperer les information des images
...
function getImage(titre, urlImage){
    ...
    return `<div class="col p-3">
                <div class="image-card text-white">
                    <img src="${urlImage}" alt="titre-img" class="rounded w-100" />
